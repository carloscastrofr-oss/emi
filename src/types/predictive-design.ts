...
export const PredictiveDesignInputSchema = z.object({
  ...
  maxScreens: z
    ...
    .int()
    .positive()
    .describe("Maximum number of screens to generate per flow."),
...
export const PredictiveDesignOutputSchema = z.object({
  ...
  journeyUrls: z
    .array(z.string().url())
    .describe("An array of URLs to the generated FigJam journey maps."),
  wireframeFrames: z
    .array(z.string())
    .describe("An array of Figma frame IDs for the generated wireframes."),
