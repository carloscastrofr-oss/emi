...
const mockInsights = [
  {
    sentiment: "negative",
    topic: "Claridad del Pago",
    quote:
      "No estoy seguro de qué pasará al hacer clic en 'Proceder al Pago'. ¿Me cobrarán inmediatamente?",
    persona: "Ana",
  },
  {
    sentiment: "positive",
    topic: "Facilidad de Navegación",
    quote:
      "Usando mi lector de pantalla, pude navegar por los productos sin problemas. ¡Bien hecho!",
    persona: "David",
  },
  {
    sentiment: "neutral",
    topic: "Información del Producto",
    quote: "La descripción del producto es adecuada, pero me gustaría ver más imágenes.",
    persona: "Elena",
  },
  {
    sentiment: "negative",
    topic: "Confianza",
    quote:
      "El diseño se ve un poco simple, no estoy seguro si es seguro poner mi tarjeta de crédito aquí.",
    persona: "Carlos",
  },
];
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Verbatims generados por el panel sintético y agrupados por tema y sentimiento.
          </CardDescription>
        </CardHeader>
      </Card>
