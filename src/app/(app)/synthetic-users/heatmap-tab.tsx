  ...
  return (
      <Card className="rounded-expressive shadow-e2 h-full">
        <CardHeader>
            ...
            <CardDescription>Visualización de clics simulados. Las áreas naranjas indican mayor interacción.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="relative w-full h-[400px] bg-card border rounded-lg p-6 overflow-hidden font-sans">
            ...
            <div className="flex flex-col h-full text-sm">
                ...
                <div className="mt-auto pt-4 border-t space-y-2">
                    <div className="flex justify-between"><div className="h-4 bg-muted rounded w-1/4"></div><div className="h-4 bg-muted rounded w-1/4"></div></div>
