          ...
          <CardHeader>
            <div className="flex flex-wrap justify-between items-center gap-4">
              <div>
                ...
                <CardDescription>
                  Selecciona un tipo de análisis: mapas de calor, A/B tests, rendimiento o auditoría
                  IA.
                </CardDescription>
              </div>
            ...
            >
              ...
              <TabsContent value="page" className="pt-4">
                ...
                <Select
                  ...
                  value={analysis.type === "page" ? (analysis.id ?? "") : ""}
                >
              ...
              <TabsContent value="test" className="pt-4">
                ...
                <Select
                  onValueChange={handleSelectionChange}
                  value={analysis.type === "test" ? (analysis.id ?? "") : ""}
                >
                  <SelectTrigger className="w-full md:w-[320px]">
              ...
              <TabsContent value="performance" className="pt-4">
                ...
                <Select
                  onValueChange={handleSelectionChange}
                  value={analysis.type === "performance" ? (analysis.id ?? "") : ""}
                >
                  <SelectTrigger className="w-full md:w-[320px]">
                    <SelectValue placeholder="Selecciona un ítem de rendimiento" />
                  </SelectTrigger>
                  <SelectContent>
