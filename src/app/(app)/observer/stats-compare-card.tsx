        ...
        <CardContent className="space-y-6">
          <div>
            <div className="flex justify-between items-baseline mb-2">
              ...
              {stats.significant && (
                <Badge className="bg-green-600">Estadísticamente Significativo</Badge>
              )}
            </div>
            ...
            <TableBody>
              {otherMetrics.map((metric) => (
                <TableRow key={metric.name}>
                  ...
                  <TableCell
                    className={`text-center font-mono font-bold ${metric.diff.startsWith("+") ? "text-green-600" : "text-red-600"}`}
                  >
                    {metric.diff}
                  </TableCell>
                </TableRow>
