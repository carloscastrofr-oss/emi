      ...
      <Card className="rounded-expressive shadow-e2">
        <CardHeader className="flex flex-row items-start gap-4">
          ...
          <div>
            ...
            <CardDescription>
              Análisis detallado de las métricas de rendimiento web.
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent>
        ...
        <Card className="rounded-expressive shadow-e2">
          <CardHeader className="flex flex-row items-start gap-4">
            ...
            <div>
              ...
              <CardDescription>
                Representación visual del {item === "button" ? "componente" : "plantilla"} bajo
                análisis.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="flex min-h-[250px] items-center justify-center p-6 bg-muted/50 rounded-b-expressive">
            {item === "button" && <Button size="lg">Botón Primario</Button>}
            {item === "checkout" && (
        ...
        <Card className="rounded-expressive shadow-e2 h-full">
          <CardHeader className="flex flex-row items-center gap-4">
            ...
            <div>
              ...
              <CardDescription>
                Monitorización contínua del rendimiento a lo largo del tiempo.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
