  ...
  return (
    <Card className="rounded-expressive">
      <CardHeader>
        ...
        <CardDescription>Audita un archivo de Figma en busca de problemas de accesibilidad y consistencia con el DS.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
            ...
            <Select defaultValue="AA">
              <SelectTrigger id="review-level"><SelectValue /></SelectTrigger>
              <SelectContent>
