          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription
                  className={cn(hasCriticalRisk ? "text-destructive-foreground/80" : "")}
                >
                  {risks.length} riesgo{risks.length !== 1 ? "s" : ""} abierto
                  {risks.length !== 1 ? "s" : ""}
                </CardDescription>
              </div>
            </div>
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    ...
                    <div className="flex gap-2">
                      {risk.ownerUid ? (
                        ...
                        <Button size="sm" variant="outline" onClick={() => setModalRisk(risk)}>
                          Asignar
                        </Button>
                      )}
